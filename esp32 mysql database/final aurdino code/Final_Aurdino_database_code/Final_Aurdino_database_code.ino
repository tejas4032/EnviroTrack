...
#define DHTPIN 25 //--> Defines the Digital Pin connected to the DHT11 sensor.
...
void loop() {
  ...
  if(WiFi.status()== WL_CONNECTED) {
    ...
    http.begin("http://192.168.132.172/ESP32_MySQL_Database/Final/getdata.php");  //--> Specify request destination
    ...
    // Example : http.begin("http://192.168.202.172/ESP32_MySQL_Database/Final/updateDHT11data_and_recordtable.php");
    http.begin("http://192.168.132.172/ESP32_MySQL_Database/Final/updateDHT11data_and_recordtable.php");  //--> Specify request destination
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");  //--> Specify content-type header
