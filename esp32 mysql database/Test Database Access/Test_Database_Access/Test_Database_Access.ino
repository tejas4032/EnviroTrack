...
#define DHTPIN 23 //--> Defines the Digital Pin connected to the DHT11 sensor.
...
void loop() {
  ...
  if(WiFi.status()== WL_CONNECTED) {
    ...
    // Example : http.begin("http://192.168.202.172/ESP32_MySQL_Database/Test/getdata.php");
    http.begin("http://192.168.202.172/ESP32_MySQL_Database/Test/getdata.php");  //--> Specify request destination
    ...
    // Example : http.begin("http://192.168.202.172/ESP32_MySQL_Database/Test/updateDHT11data.php");
    http.begin("http://192.168.202.172/ESP32_MySQL_Database/Test/updateDHT11data.php");  //--> Specify request destination
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");  //--> Specify content-type header
